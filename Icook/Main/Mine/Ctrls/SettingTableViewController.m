...
@implementation SettingTableViewController
{
    ...
    __weak IBOutlet UIImageView *_userIconImageView;
    __weak IBOutlet UILabel *_userNameLLabel;
    
    __weak IBOutlet UILabel *_userIdInfo;
...
- (void)viewDidLoad {
    ...
    _userIconImageView.layer.cornerRadius = _userIconImageView.frame.size.width / 2;
